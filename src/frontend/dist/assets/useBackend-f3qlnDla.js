...
import { m as Subscribable, p as pendingThenable, n as resolveEnabled, s as shallowEqualObjects, o as resolveStaleTime, q as noop, t as environmentManager, v as isValidTimeout, w as timeUntilStale, x as timeoutManager, y as focusManager, z as fetchState, B as replaceData, E as notifyManager, F as hashKey, G as getDefaultState, r as reactExports, H as shouldThrowError, I as useQueryClient, g as api } from "./index-Dq0ueDrX.js";
...
function useCreateWriteup() {
  ...
  return useMutation({
    mutationFn: (input) => api.createWriteup(input),
    onSuccess: () => {
...
function useUpdateWriteup() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: ({ id, input }) => api.updateWriteup(id, input),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["writeups"] });
      qc.invalidateQueries({ queryKey: ["all-writeups"] });
...
function useDeleteWriteup() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: (id) => api.deleteWriteup(id),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["writeups"] });
      qc.invalidateQueries({ queryKey: ["all-writeups"] });
    }
...
export {
  ...
  useWriteupById as i,
  useCreateWriteup as j,
  useUpdateWriteup as k,
  useUploadImage as l,
  useUploadFile as m,
